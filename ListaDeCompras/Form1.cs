...
namespace ListaDeCompras
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdicionar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("O nome do produto não pode estar vazio!", "Erro!",
            ...
            {
                MessageBox.Show("O nome do produto precisa ter no minimo duas letras!", "Erro!",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                // Mudar a cor do fundo e a cor da letra:
                txbProduto.BackColor = Color.Red;
                txbProduto.ForeColor = Color.White;
            ...
            else
            {
                ...
                {
                    MessageBox.Show($"Já exite {txbProduto.Text} na lista!", "Erro!",
